...
const ProfReports = {
  template: `
    <div class="container py-5">
      ...
      <div v-else class="text-center mt-4">
        <p class="text-muted">No reports available for you.</p>
      </div>
    </div>
  `,
  data() {
  ...
  methods: {
    fetchUserReports() {
      ...
      fetch(`/api/get-prof-pdfs/${userId}`)
    ...
    downloadPDF(pdfFilename) {
      ...
      const url = `/api/download-prof-pdf/${encodedFilename}`;
